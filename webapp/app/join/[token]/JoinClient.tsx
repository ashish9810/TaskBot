...
const s: Record<string, React.CSSProperties> = {
  ...
  icon: { width: '56px', height: '56px', borderRadius: '14px', background: 'linear-gradient(135deg, #E06C4D, #F0926E)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '24px', fontWeight: 700, color: 'white' },
  ...
  errorBox: { background: "rgba(185,28,28,0.06)", border: "1px solid rgba(185,28,28,0.25)", borderRadius: '8px', padding: '12px 14px', fontSize: '13px', color: "#B91C1C", marginBottom: '16px', textAlign: 'left' as const, lineHeight: 1.5 },
